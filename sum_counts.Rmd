...
Between September 2019 and March 2020, the data were collected from the registered teams' affiliations. All the teams followed the [data collection protocol](https://osf.io/xrg84/). This data collection suspended at March 2020 because of the global pandemic outbreak. 
...
The osweb teams collected the data from the languages as following: `r unique(sum_osweb$Language)`. Across the osweb data, `r sum(sum_osweb$SP_N)` participants finished sentence-picture verification task; `r sum(sum_osweb$PP_N)` participants finished picture-picture verification task.
