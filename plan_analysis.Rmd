...
```{r summary_table, echo=FALSE, message=FALSE, warning=FALSE, paged.print=TRUE, fig.cap="Average reaction time (ms) and accuracy percentil in brackets."}
SP_V_en %>%
...
**Step 3 Analyze Orientation Effect**
...
## Run linear model
EN_full_model <- lmer(response_time ~ Match + (1|subject_nr) + (1|Target),
                 data = SP_V_en_mutate)
